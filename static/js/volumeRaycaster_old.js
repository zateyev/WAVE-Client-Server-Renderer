...
var Core = function(conf) {
    ...
    this._camera_settings = {
        ...
        "position": {
            "x": -0.8065057282686177, // up: 0.6974465435275045 0.7165896067047339 -0.008225234603207926
            "y": 0.7751158635322308,
            "z": -0.8576850457452835
        }
    };
...
window.VRC.Core.prototype._shaders.secondPassSoebel = {
	...
	fragmentShader: [
		...
		'      if (distanceFromCenter < 0.47 && vpos.z > 0.1 && vpos.z < 0.9) {',
		'        vec3 gray_val = getVolumeValue(vpos.xyz);',
		'        /************************************/',
		'        /*         Mean filtering           */',
		'        /************************************/',
		'        if (gray_val.x > minSos && gray_val.x < maxSos) {',
